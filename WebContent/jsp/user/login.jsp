...
<body>
    ...
    <main class="page landing-page">
        <section class="clean-block clean-hero" style="background-image:url(&quot;tech/image4.jpg&quot;);color:rgba(9, 162, 255, 0.85);">
            <div class="float-right text col-md-6" style="margin:0;margin-right:0px;margin-left:-427px;">
                <h2>Learning And Code</h2>
                <p>러닝 앤 코드</p><button class="btn btn-outline-light btn-lg" type="button">Learn More</button></div>
            <div class="float-right text col-md-6 login-clean" style="margin-right:-383px;">
                <form method="post">
